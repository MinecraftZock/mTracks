...
public class GetWeatherDailyAnonymResult extends ServiceResult {
	private int cod;
	...
	public GetWeatherDailyAnonymResult(JsonEntityReaderProvider provider, InputStream inStream) throws IOException {
		JsonReader reader = null;
		try {
			if(inStream != null) {
				reader = new JsonReader(new BufferedReader(new InputStreamReader(inStream, Charset.defaultCharset())));
		GetWeatherDailyAnonymResult subject = this;
		reader.beginObject();
