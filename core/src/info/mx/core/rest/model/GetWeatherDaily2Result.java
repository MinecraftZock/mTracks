...
public class GetWeatherDaily2Result implements Serializable, Parcelable {
    ...
    @SerializedName("list")
    @Expose
    private java.util.List<info.mx.core.rest.model.List> list = null;
    public final static Parcelable.Creator<GetWeatherDaily2Result> CREATOR = new Creator<>() {
        ...
        public GetWeatherDaily2Result createFromParcel(Parcel in) {
            ...
            in.readParcelableList(instance.list, info.mx.core.rest.model.List.class.getClassLoader(), info.mx.core.rest.model.List.class);
            return instance;
        }
    ...
    public java.util.List<info.mx.core.rest.model.List> getList() {
        return list;
    }

    public void setList(java.util.List<info.mx.core.rest.model.List> list) {
        this.list = list;
    }
