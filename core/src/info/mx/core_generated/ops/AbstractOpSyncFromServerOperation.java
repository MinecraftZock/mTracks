...
public abstract class AbstractOpSyncFromServerOperation extends Operation {
    ...
    public static class Configuration extends OperationConfiguration {
		...
		public Intent findMatchOnConstraint(OperationServiceBridge bridge, Intent intent) {
            ...
            return bridge.findPendingRequestByActionWithExtras(AbstractOpSyncFromServerOperation.ACTION_OP_SYNC_FROM_SERVER, intent.getExtras());
			
		}
	}
	
	public static Intent newIntent(boolean updateProvider, String flavor) {
