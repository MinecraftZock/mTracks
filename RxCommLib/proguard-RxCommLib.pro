...
## We want to keep the line number of the sourcefile for crash reporting
-renamesourcefileattribute SourceFile
-keepattributes SourceFile,LineNumberTable

# Adding optimization introduces
...
# Preserve classes referended only in XML


# Preserve all View implementations, their special context constructors, and
# their setters in Views so that animations can still work.
...
### Schema Converter ###
# Does proguard not recognize compatibility 1.7?
