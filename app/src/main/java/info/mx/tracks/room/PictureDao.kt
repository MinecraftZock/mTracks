...
import info.mx.tracks.room.entity.PictureSum
...
interface PictureDao {
    ...
    @Query("SELECT * FROM PictureSum WHERE trackId = :trackId")
    fun getPictureSumByTrackId(trackId: Long): Flow<PictureSum?>

    @Query("SELECT * FROM PictureSum")
    fun getAllPictureSums(): Flow<List<PictureSum>>
