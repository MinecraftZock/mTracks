...
@Database(entities = [CapturedLatLng::class, Comment::class, Country::class, Event::class,
    ...
    TrackStage::class, Weather::class],
    views = [CountryCount::class, CountrySum::class, RatingSum::class, EventSum::class, PictureSum::class, TracksGes::class, TracksGesSum::class],
    version = 2)
