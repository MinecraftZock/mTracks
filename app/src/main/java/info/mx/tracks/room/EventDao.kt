...
import info.mx.tracks.room.entity.EventSum
...
interface EventDao {
    ...
    @Query("SELECT * FROM EventSum WHERE trackRestId = :trackRestId")
    fun getEventSumByTrackId(trackRestId: Long): Flow<EventSum?>

    @Query("SELECT * FROM EventSum")
    fun getAllEventSums(): Flow<List<EventSum>>
