...
abstract class BaseMapTest(private val restTrackId: Long, private val pressBack: Boolean) : BaseSyncTest() {

    private val intent = Intent(ApplicationProvider.getApplicationContext(), ActivityMapExtension::class.java).apply {
...
//        putExtra(FragmentUpDown.CONTENT_URI, MxInfoDBContract.Tracksges.CONTENT_URI)
    ...
    @get:Rule
    val activityScenarioRule = activityScenarioRule<ActivityMapExtension>(intent)
