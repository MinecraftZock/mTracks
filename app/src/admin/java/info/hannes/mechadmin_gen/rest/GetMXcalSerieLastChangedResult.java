...
public class GetMXcalSerieLastChangedResult extends ServiceResult {
	private List<RESTmxcalSerie> rESTmxcalSeries;
	public List<RESTmxcalSerie> getRESTmxcalSeries(){
		return this.rESTmxcalSeries;
	}

	public GetMXcalSerieLastChangedResult(JsonEntityReaderProvider provider, InputStream inStream) throws IOException {
