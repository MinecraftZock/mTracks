...
public class GetMXcalQuellfileLastChangedResult extends ServiceResult {
	...
	public GetMXcalQuellfileLastChangedResult(JsonEntityReaderProvider provider, InputStream inStream) throws IOException {
