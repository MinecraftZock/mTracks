...
public class GetMXcalTrackFromResult extends ServiceResult {
	private List<RESTmxcalTrack> rESTmxcalTracks;
	public List<RESTmxcalTrack> getRESTmxcalTracks(){
		return this.rESTmxcalTracks;
	}

	public GetMXcalTrackFromResult(JsonEntityReaderProvider provider, InputStream inStream) throws IOException {
