...
public class PutMXcalSerieResult extends ServiceResult {
	private CalBaseResponse calBaseResponse;
	public CalBaseResponse getCalBaseResponse(){
		return this.calBaseResponse;
	}

	public PutMXcalSerieResult(JsonEntityReaderProvider provider, InputStream inStream) throws IOException {
