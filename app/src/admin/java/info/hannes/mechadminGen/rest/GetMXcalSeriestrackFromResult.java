...
public class GetMXcalSeriestrackFromResult extends ServiceResult {
	...
	public GetMXcalSeriestrackFromResult(JsonEntityReaderProvider provider, InputStream inStream) throws IOException {
