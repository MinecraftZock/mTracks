...
public abstract class AbstractOpFacebookSplitOperation extends Operation {
	public static final String ACTION_OP_FACEBOOK_SPLIT = "info.hannes.mechadmin.ops.StageingService.actions.OP_FACEBOOK_SPLIT";
	...
	static class Configuration extends OperationConfiguration {
		...
		public Operation createOperation() {
			return new OpFacebookSplitOperation();
		}
		
		@Override
		public Intent findMatchOnConstraint(OperationServiceBridge bridge, Intent intent) {
			Intent existingRequest = bridge.findPendingRequestByActionWithExtras(AbstractOpFacebookSplitOperation.ACTION_OP_FACEBOOK_SPLIT, intent.getExtras());
	...
	public static final Intent newIntent(String flavor) {
		Intent intent = new Intent(ACTION_OP_FACEBOOK_SPLIT);
