...
//                executeShellCommand("appops set " + getApplicationContext<Context>().packageName + " android:mock_location allow")
                executeShellCommand("appops set " + getInstrumentation().context.packageName + " android:mock_location allow")
                Thread.sleep(1000)
            }
        }
        mockLocation()
