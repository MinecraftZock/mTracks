...
internal class EventAdapter(private val context: Context) : RecyclerView.Adapter<EventAdapter.PostViewHolder>() {
    ...
    internal inner class PostViewHolder(val binding: ItemEventBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    internal inner class EventDiffCallback(private val oldEvent: List<Event>, private val newEvent: List<Event>) : DiffUtil.Callback() {
