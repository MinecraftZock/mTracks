...
public class PostMXcalSerieResult extends ServiceResult {
	private CalBaseResponse calBaseResponse;
	public CalBaseResponse getCalBaseResponse(){
		return this.calBaseResponse;
	}
	
	public PostMXcalSerieResult(JsonEntityReaderProvider provider, InputStream inStream) throws IOException {
