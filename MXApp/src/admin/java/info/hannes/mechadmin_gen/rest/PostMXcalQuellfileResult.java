...
public class PostMXcalQuellfileResult extends ServiceResult {
	private CalBaseResponse calBaseResponse;
	public CalBaseResponse getCalBaseResponse(){
		return this.calBaseResponse;
	}

	public PostMXcalQuellfileResult(JsonEntityReaderProvider provider, InputStream inStream) throws IOException {
